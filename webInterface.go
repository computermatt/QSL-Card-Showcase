...
func index(w http.ResponseWriter, r *http.Request) {
	...
	fmt.Fprintf(w, "<a href=/view/"+call +">" + call + "</a><img src=\"../resizedCards/" + jsontype[i].Front_image + convertedType + "\" width=100 height=60></img>  <img src=\"../resizedCards/" + jsontype[i].Back_image + convertedType + "\" width=100 height=60></img></br>")
    }
}
...
func displayCard(w http.ResponseWriter, r *http.Request) {
	...
	if jsontype[i].Callsign == callToCheck {
	    ...
	    fmt.Fprintf(w, "</br><a href=../cards/" + jsontype[i].Front_image + fullType + "> Download full sized image </a>")
	    ...
	    fmt.Fprintf(w, "</br><a href=../../cards/" + jsontype[i].Back_image + fullType + "> Download full sized image </a>")
	}
    }
}
